...
<div class="navbar bg-base-100/80 backdrop-blur sticky top-0 z-50 border-b border-base-content/10 px-4 lg:px-12">
  ...
  <div class="navbar-end gap-2">
    ...
    <?php if ($navLoggedIn): ?>
      <!-- Direct unsubscribe button (desktop/laptop only; on phone & tablet it lives inside the profile) -->
      <button type="button" onclick="navUnsubscribe(this)" class="btn btn-ghost btn-sm md:btn-md text-error hidden lg:inline-flex">আনসাবস্ক্রাইব</button>
